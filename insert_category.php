    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="text-center"> Ingreso categoria</h3>
            </div>
            <div class="col-md-12">
                <form class="form-group" accept-charset="utf-8" action="save_category.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <br> Comente excedente de cajas extraidas de el archivo welcome.php-->
                        ...
                        <!--<select id="categoria" name="categoria" class="form-control">
                           <?php
                            ...
                            $data = $stmt->fetchAll();
                            /*
                            ->select de insert product $sql = "SELECT id_category, category_name from categories order by category_name; ";
                            $sql="insert into categories (category_name) VALUES ('categoria_prueba'); ";
