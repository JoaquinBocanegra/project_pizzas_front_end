...
<body>
    ...
    <div class="mainContent">
        ...
        <ul class="gallery">
            ...
            include_once("db.php");
            $link= new Db();
            $sql="SELECT p.product_name, p.price,date_format(p.start_date,'%d/%m/%y') as date, p.image, c.category_name from products p inner join categories c on c.id_category=p.id_category;";
